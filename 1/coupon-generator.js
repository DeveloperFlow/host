var _$ = function(){ 
   ...
   var editableLinkAppearance = "jasper.ai" /*how the link appears in the pop up beside the instruction, you can just leave it blank if there is no link that the user should be able to click*/
